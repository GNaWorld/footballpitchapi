...
public class AutoBindRoutes extends Routes {
    ...
    public AutoBindRoutes addExcludeClasses(@SuppressWarnings("unchecked") Class<? extends 
...
Controller>... clazzes) {
    ...
    public void config() {
        List<Class<? extends Controller>> controllerClasses = ClassSearcher.of
...
(Controller.class)
        ...
        for (Class controller : controllerClasses) {
            ...
            controllerBind = (ControllerBind) controller.getAnnotation

(ControllerBind.class);
...
controller + ","
    ...
    private String controllerKey(Class<Controller> clazz) {
        Preconditions.checkArgument(clazz.getSimpleName().endsWith(suffix),
                clazz.getName()+" is not annotated with @ControllerBind and not end with " 
