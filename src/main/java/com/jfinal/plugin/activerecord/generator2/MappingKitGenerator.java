...
"/com/jfinal/plugin/activerecord/generator/mapping_kit_template.jf";
	...
	public MappingKitGenerator(String mappingKitPackageName, String 
...
mappingKitOutputDir) {
	...
	public void setMappingKitClassName(String mappingKitClassName) {
		if (StrKit.notBlank(mappingKitClassName)) {
			this.mappingKitClassName = StrKit.firstCharToUpperCase
...
(mappingKitClassName);
	...
	protected void writeToFile(String ret) {
		...
		try {
			...
			String target = mappingKitOutputDir + File.separator + 

mappingKitClassName + ".java";
