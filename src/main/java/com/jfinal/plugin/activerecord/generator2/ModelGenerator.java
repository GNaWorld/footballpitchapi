...
"/com/jfinal/plugin/activerecord/generator/model_template.jf";
	...
	public ModelGenerator(String modelPackageName, String baseModelPackageName, String 
...
modelOutputDir) {
		...
		if (modelPackageName.contains("/") || modelPackageName.contains("\\")) {
			throw new IllegalArgumentException("modelPackageName error : " + 
...
+ baseModelPackageName);
	...
	protected void genModelContent(TableMeta tableMeta) {
		...
		String ret = Engine.use("forModel").getTemplate(template).renderToString
...
(data);
	...
	protected void writeToFile(TableMeta tableMeta) throws IOException {
		...
		String target = modelOutputDir + File.separator + tableMeta.modelName + 
